...
const authWindow = (config) => {
    ...
    return framework_1.context('authWindow', {
        ...
        login: (pair) => new Promise((resolve, reject) => {
            ...
            const authCodeUrl = `https://${config.auth0.domain}/authorize?` + qs_1.default.stringify(Object.assign({ audience: config.auth0.audience, scope: scopes.join(' '), response_type: 'code', client_id: config.auth0.clientId, code_challenge: pair.challenge, code_challenge_method: 'S256', redirect_uri: `https://${config.auth0.domain}/mobile` }, (_a = config.login) === null || _a === void 0 ? void 0 : _a.authorizeParams));
